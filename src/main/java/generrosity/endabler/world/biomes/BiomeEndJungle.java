...
import generrosity.endabler.world.feature.WorldGenEndPlant;
import generrosity.endabler.world.feature.WorldGenEnderCanopy;
...
{
	public static BiomeProperties properties = new BiomeProperties("Endabler Growth");
    ...
    {	
		...
		if(randy.nextInt(Configsable.worldgen.treeFrequency) == 0)
		{
